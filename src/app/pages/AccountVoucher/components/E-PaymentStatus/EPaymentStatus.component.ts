...
import { EPaymentStatusService } from './EPaymentStatus.service';
@Component(
  {
    selector: 'EPaymentStatus',
    templateUrl: './EPaymentStatus.html',
    providers: [EPaymentStatusService],
    styleUrls: ["../../../modal-style.css"],
  }
)
export class EPaymentStatusComponent {
  ...
  constructor(private masterService: MasterRepo,
    ...
    protected _LatePostService: EPaymentStatusService,
