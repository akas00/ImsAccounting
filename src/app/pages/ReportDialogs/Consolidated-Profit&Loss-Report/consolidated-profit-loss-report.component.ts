...
@Component({
    ...
    templateUrl: './consolidated-profit-loss-report.component.html',
...
export class ConsolidatedProfitLossReport implements OnInit {
    ...
    changeEntryDate(value, format: string) {
        ...
        if (format == "AD") {
            ...
            this._reportFilterService.ConsolidatedProfitLossObj.Consolidated_ProfitLoss_BSDATE1 = (bsDate.en.day == '1' || bsDate.en.day == '2' || bsDate.en.day == '3' || bsDate.en.day == '4' || bsDate.en.day == '5' || bsDate.en.day == '6' || bsDate.en.day == '7' || bsDate.en.day == '8' || bsDate.en.day == '9' ? '0' + bsDate.en.day : bsDate.en.day) + '/' + bsDate.en.month + '/' + bsDate.en.year;
        }
        else if (format == "BS") {
            ...
            if (Validatedata == true) {
                ...
                this._reportFilterService.ConsolidatedProfitLossObj.Consolidated_ProfitLoss_DATE1 = (adDate1.year + '-' + ((adDate1.month).toString().length == 1 ? '0' + adDate1.month : adDate1.month) + '-' + ((adDate1.day).toString().length == 1 ? '0' + adDate1.day : adDate1.day));
            } else {
    ...
    changeEndDate(value, format: string) {
        ...
        if (format == "AD") {
            var adDate = (value.replace("-", "/")).replace("-", "/");
            var bsDate = adbs.ad2bs(adDate);
            this._reportFilterService.ConsolidatedProfitLossObj.Consolidated_ProfitLoss_BSDATE2 = (bsDate.en.day == '1' || bsDate.en.day == '2' || bsDate.en.day == '3' || bsDate.en.day == '4' || bsDate.en.day == '5' || bsDate.en.day == '6' || bsDate.en.day == '7' || bsDate.en.day == '8' || bsDate.en.day == '9' ? '0' + bsDate.en.day : bsDate.en.day) + '/' + bsDate.en.month + '/' + bsDate.en.year;
        }
        else if (format == "BS") {
            var datearr = value.split('/');
            const bsDate = datearr[2] + "/" + datearr[1] + "/" + datearr[0]
            var adDate = adbs.bs2ad(bsDate);
            this._reportFilterService.ConsolidatedProfitLossObj.Consolidated_ProfitLoss_DATE2 = (adDate.year + '-' + ((adDate.month).toString().length == 1 ? '0' + adDate.month : adDate.month) + '-' + ((adDate.day).toString().length == 1 ? '0' + adDate.day : adDate.day));
        }
    }
