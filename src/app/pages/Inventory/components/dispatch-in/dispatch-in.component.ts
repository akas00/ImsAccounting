...
@Component({
    selector: "dispatchIn",
    templateUrl: "./dispatch-in.component.html",
...
export class DispatchInComponent {
    ...
    voucherType: VoucherTypeEnum = VoucherTypeEnum.DeliveryReturn;
    ...
    constructor(public masterService: MasterRepo, private _trnMainService: TransactionService, private router: Router, private arouter: ActivatedRoute,private _hotkeysService: HotkeysService,private setting:SettingService) {
        ...
        this.TrnMainObj.VoucherPrefix = 'DR';
        this.TrnMainObj.VoucherType = VoucherTypeEnum.DeliveryReturn;
        this._trnMainService.pageHeading = "Dispatch In";
        this.voucherType = VoucherTypeEnum.DeliveryReturn;
